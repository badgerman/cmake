...
IF(TOLUA_LIBRARY)
  IF(UNIX AND NOT APPLE)
    FIND_LIBRARY(TOLUA_DL_LIBRARY dl)
    SET(TOLUA_LIBRARIES "${TOLUA_LIBRARY};${TOLUA_DL_LIBRARY}" CACHE STRING "ToLua Libraries")
  ELSE(UNIX AND NOT APPLE)
    SET(TOLUA_LIBRARIES "${TOLUA_LIBRARY}" CACHE STRING "Lua Libraries")
